...
Sessão (SESSION) é uma funcionaliade usada para o controle de acesso e outras informações que sejam importantes enquanto o navegador estiver aberto com o site.

Exemplos: áreas administrativas, painel de controle/dashboard, área do cliente, área do aluno etc.

Nestas áreas o acesso se dá através de alguma forma de autentificação. Exemplos: login/senha, biometria, facial, 2-fatores etc. */
